##########
![aisvs_logo](../images/aisvs-logo-light.png)
...
|            |            |              |                            |
| ---------- | ---------- | ------------ | -------------------------- |
| Jim Manico | Otto Sulin | Rico Komenda | Aras "Russ" Malesification |

## Contributors and Reviewers

We have included a list of contributors and reviewers in [Appendix E](0x94-Appendix-E_Contributors.md).

If a credit is missing, please open an issue or pull request on GitHub to ensure it is recognized in future updates.
