...
Define which AI decisions and agent actions require human approval so runtime gates can enforce them, and define the system behavior when approval is not provided in time.

|   #    | Description                                                                                                                                                                                                                                                              | Level |
| :----: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :---: |
| 14.2.1 | Verify that the documented human oversight policy specifies which AI decisions and agent actions are classified as high-risk, the criteria used to make that determination, and the approval authority required before execution.                                        |   1   |
...
| 14.2.3 | Verify that any deviation from the fail-closed default for an approval TTL expiration is explicitly authorized in the human oversight policy (C14.2.1) and that the deviation itself is classified as a high-risk policy decision requiring approval authority sign-off. |   2   |
